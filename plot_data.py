...
single_mom_sig_x, single_mom_sig_y, single_mom_sig_yerr, single_mom_sig_yin, single_mom_sig_yout, bin_width = get_singmom_weight_in_out(single_signal[:,3], single_signal[:,0], 0, 250, 35)
single_mom_bkg_x, single_mom_bkg_y, single_mom_bkg_yerr, single_mom_bkg_yin, single_mom_bkg_yout, bin_width = get_singmom_weight_in_out(single_background[:,3], single_background[:,0], 0, 250, 35)
plt.subplot(2,1,1)
plt.errorbar(single_mom_sig_x, single_mom_sig_y, yerr=single_mom_sig_yerr, color='#FF5959',label='Signal', capsize=4, marker='s',markersize=3,linewidth=1,elinewidth=2)
...
plt.xlabel('Single Track Momemtum (GeV)')
plt.ylim(0,1)
plt.xlim(0,250)
plt.tight_layout()
plt.savefig('plots/single_mom_er',bbox_inches='tight')
